...
function clearEffects() {
    ...
    glitchBtn.style.backgroundColor = '#555';
...
function toggleGlitch() {
    isGlitch = !isGlitch;
    glitchBtn.style.backgroundColor = isGlitch ? '#777' : '#555';
}

// 4.10. Toggle Analog Effect
function toggleAnalog() {
    isAnalog = !isAnalog;
    analogBtn.style.backgroundColor = isAnalog ? '#777' : '#555';
}

// 4.11. Toggle Trails Effect
function toggleTrails() {
    isTrails = !isTrails;
    trailsBtn.style.backgroundColor = isTrails ? '#777' : '#555';
}
...
function triggerRandomEffect() {
    ...
    switch (randomEffect) {
        case 'glitch':
            if (!isGlitch) {
                isGlitch = true;
                glitchBtn.style.backgroundColor = '#777';
                setTimeout(() => {
                    isGlitch = false;
                    glitchBtn.style.backgroundColor = '#555';
                }, 300);
        ...
        case 'analog':
            if (!isAnalog) {
                isAnalog = true;
                analogBtn.style.backgroundColor = '#777';
                setTimeout(() => {
                    isAnalog = false;
                    analogBtn.style.backgroundColor = '#555';
                }, 300);
        ...
        case 'trails':
            if (!isTrails) {
                isTrails = true;
                trailsBtn.style.backgroundColor = '#777';
                setTimeout(() => {
                    isTrails = false;
                    trailsBtn.style.backgroundColor = '#555';
                }, 300);
...
function startAbstractMode() {
    ...
    abstractBtn.style.backgroundColor = '#777';
